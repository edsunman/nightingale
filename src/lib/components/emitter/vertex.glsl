...
void main() {
    ...
    float noiseAmountX = snoise(vec3(newPosition.x + vNormalLife * driftSpeed, newPosition.y, newPosition.z)) * driftAmount;
    float noiseAmountY = snoise(vec3(newPosition.x, newPosition.y + vNormalLife * driftSpeed, newPosition.z)) * driftAmount;
    float noiseAmountZ = snoise(vec3(newPosition.x, newPosition.y, newPosition.z + vNormalLife * driftSpeed)) * driftAmount;
